-- Egg Farm hotdogs v7dasdasdasdasd
-- Auto Egg Fixed
                ...
                repeat task.wait(5)
                    ...
                    if table.find(PetAilmentsArray, "moon") then
                        ...
                        repeat task.wait(1)
                            t = 1 + t
                            print('doing moon')
                        until not hasTargetAilment("moon") or t > 60
                    ...
                    if table.find(PetAilmentsArray, "salon") or table.find(BabyAilmentsArray, "salon") then
                        ...
                        repeat task.wait(1)
                            t = 1 + t
                            print('doing salon')
                        until not hasTargetAilment("salon") and not ClientData.get_data()[game.Players.LocalPlayer.Name].ailments_manager.baby_ailments["salon"] or t > 60
                        task.wait(2)
                    ...
                    if table.find(PetAilmentsArray, "pizza_party") or table.find(BabyAilmentsArray, "pizza_party") then
                        ...
                        repeat task.wait(1)
                            t = 1 + t
                            print('doing pizza')
                        until not hasTargetAilment("pizza_party") and not ClientData.get_data()[game.Players.LocalPlayer.Name].ailments_manager.baby_ailments["pizza_party"] or t > 60
                        task.wait(2)
                    ...
                    if table.find(PetAilmentsArray, "bored") then
                        ...
                        if getgenv().PianoID then
                            ...
                            repeat task.wait(1)
                                t = 1 + t
                                print('doing bored')
                            until not hasTargetAilment("bored") or t > 60
                            local args = {
                                [1] = getgenv().fsys.get("pet_char_wrappers")[1].pet_unique
                            }
                    ...
                    if table.find(PetAilmentsArray, "beach_party") or table.find(BabyAilmentsArray, "beach_party") then
                        ...
                        repeat task.wait(1)
                            t = 1 + t
                            print('doing beach')
                        until not hasTargetAilment("beach_party") and not ClientData.get_data()[game.Players.LocalPlayer.Name].ailments_manager.baby_ailments["beach_party"] t > 60
                        task.wait(2)
                    ...
                    if table.find(PetAilmentsArray, "camping") or table.find(BabyAilmentsArray, "camping") then
                        ...
                        repeat task.wait(1)
                            t = 1 + t
                            print('doing camping')
                        until not hasTargetAilment("camping") and not ClientData.get_data()[game.Players.LocalPlayer.Name].ailments_manager.baby_ailments["camping"] or t > 60
                        task.wait(2)
                    ...
                    if table.find(BabyAilmentsArray, "dirty") then
                        ...
                        if getgenv().ShowerID then
                            ...
                            repeat task.wait(1)
                                t = 1 + t
                                print('doing dirty')
                            until not ClientData.get_data()[game.Players.LocalPlayer.Name].ailments_manager.baby_ailments["dirty"] or t > 60
                            BabyJump()
                    ...
                    if table.find(BabyAilmentsArray, "sleepy") then
                        ...
                        if getgenv().BedID then
                            ...
                            repeat task.wait(1)
                                t = 1 + t
                                print('doing sleepy')
                            until not ClientData.get_data()[game.Players.LocalPlayer.Name].ailments_manager.baby_ailments["sleepy"] or t > 60
                            BabyJump()
