...
if not getgenv().AutoGet then
    ...
    for _, pet in pairs(petsdata) do
        if pet.id == "house_pets_2025_siamese_cat" and pet.properties.age < 6 then
    ...
    while true do
        ...
        for _, pet in pairs(pets) do
            if pet.kind == "house_pets_2025_siamese_cat" or pet.kind == "house_pets_2025_munchkin_cat" or pet.kind == "house_pets_2025_mini_schnauzer" or pet.kind == "house_pets_2025_french_bulldog" then
