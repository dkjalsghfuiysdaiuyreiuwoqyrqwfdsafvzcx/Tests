...
if not getgenv().ScriptRunning then
    ...
    function teleportToHouse()
        ...
        for _, player in ipairs(Players:GetPlayers()) do
            if tostring(player.Name) ~= "PixelW0lf8_55Ne0n541" and tostring(player.Name) ~= "bubblegumh" and tostring(player.Name) ~= "bubblerice1" and tostring(player.Name) ~= "GHITTOYAH" and tostring(player.Name) ~= "ghiaxis28" and tostring(player.Name) ~= "GriffinzKQnY" then
