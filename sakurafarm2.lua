...
if not _G.ScriptRunning then
    ...
    RunService.Heartbeat:Connect(function()
        local EventChecker = game:GetService("Players").LocalPlayer.PlayerGui.DialogApp.Dialog.NormalDialog.Info.TextLabel.Text
        
        if EventChecker == "Sakura Swoop is starting soon! Teleport there now?" and not InSakura then
        ...
        while not success do
            success = pcall(function()
                if workspace.Interiors:FindFirstChild("BlossomShakedownInterior") and not InShakeDown then
                    InShakeDown = true
                    task.wait(2)
        ...
        while not inMainMap do
            inMainMap = pcall(function()
                if workspace.Interiors:FindFirstChild("MainMap!Default") then
                    ...
                    if game:GetService("Players").LocalPlayer.PlayerGui.MinigameRewardsApp.Body.Visible then
