        ...
        repeat task.wait(5)
            ...
            if table.find(FirstTableArray, "walk") or table.find(SecondTableArray, "walk") then
                ...
                repeat 
                    task.wait(1)
                    t = t + 1
                until (not hasTargetAilment("walk", petToEquipSecond) and not hasTargetAilment("walk", petToEquip)) or t == 120  -- Check only first table
            ...
            if table.find(FirstTableArray, "ride") or table.find(SecondTableArray, "ride") then
                ...
                repeat 
                    task.wait(1)
                    t = t + 1
                until (not hasTargetAilment("ride", petToEquipSecond) and not hasTargetAilment("ride", petToEquip)) or t == 120  -- Check only first table
