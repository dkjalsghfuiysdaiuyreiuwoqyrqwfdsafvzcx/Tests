...
if not getgenv().AutoGet then
    ...
    for _, pet in pairs(petsdata) do
        if pet.id == "summerfest_2025_manta_ray" and pet.properties.age < 6 then
    ...
    while true do
        ...
        for _, pet in pairs(pets) do
            if pet.kind == "summerfest_2025_manta_ray" or pet.kind == "summerfest_2025_kelp_hunter" then
