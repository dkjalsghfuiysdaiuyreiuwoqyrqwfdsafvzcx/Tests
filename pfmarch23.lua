    ...
    -- Check if current equipped pet is different before equipping
        ...
        if petToEquip then
            ...
            if getgenv().DoublePet and petToEquipSecond then
                ...
                game:GetService("ReplicatedStorage"):WaitForChild("API")
                    :WaitForChild("ToolAPI/Equip")
                    :InvokeServer(petToEquipSecond, {["use_sound_delay"] = true, ["equip_as_last"] = true})
        ...
        if getgenv().FoodID then
            ...
            if table.find(SecondTableArray, "hungry") then             
                ...
                repeat 
                    task.wait(1)
                    t = t + 1
                until not hasTargetAilment("hungry", petToEquipSecond) or t == 60  -- Check only first table
        ...
        if getgenv().WaterID then
            ...
            if table.find(FirstTableArray, "thirsty") then
                ...
                repeat 
                    task.wait(1)
                    t = t + 1
                until not hasTargetAilment("thirsy", petToEquip) or t == 60  -- Check only first table
            ...
            if table.find(SecondTableArray, "thirsty") then
                ...
                repeat 
                    task.wait(1)
                    t = t + 1
                until not hasTargetAilment("thirsty", petToEquipSecond) or t == 60  -- Check only first table
            ...
            if table.find(FirstTableArray, "moon") or table.find(SecondTableArray, "moon") then
                ...
                if table.find(FirstTableArray, "moon") then
                    ...
                    repeat 
                        task.wait(1)
                        t = t + 1
                    until not hasTargetAilment("moon", petToEquip) or t == 60  -- Check only first table
                ...
                if table.find(SecondTableArray, "moon") then
                    ...
                    local secondPet = fsys.get("pet_char_wrappers")[1]["char"]
                    -- Any additional pet-specific code would go here
                    ...
                    repeat 
                        task.wait(1)
                        t = t + 1
                    until not hasTargetAilment("moon", petToEquipSecond) or t == 60  -- Check only first table
                ...
                if getgenv().PianoID then
                    ...
                    if table.find(FirstTableArray, "bored") then
                        ...
                        repeat 
                            task.wait(1)
                            t = t + 1
                        until not hasTargetAilment("bored", petToEquip) or t == 60  -- Check only first table
                    ...
                    if table.find(SecondTableArray, "bored") then
                        ...
                        repeat 
                            task.wait(1)
                            t = t + 1
                        until not hasTargetAilment("bored", petToEquipSecond) or t == 60  -- Check only first table
                ...
                if getgenv().ShowerID then
                    if table.find(FirstTableArray, "dirty") then
                        ...
                        repeat 
                            task.wait(1)
                            t = t + 1
                        until not hasTargetAilment("dirty", petToEquip) or t == 60  -- Check only first table
                    ...
                    if table.find(SecondTableArray, "dirty") then
                        ...
                        repeat 
                            task.wait(1)
                            t = t + 1
                        until not hasTargetAilment("dirty", petToEquipSecond) or t == 60  -- Check only first table
                ...
                if getgenv().BedID then
                    if table.find(FirstTableArray, "sleepy") then
                        ...
                        repeat 
                            task.wait(1)
                            t = t + 1
                        until not hasTargetAilment("sleepy", petToEquip) or t == 60  -- Check only first table
                    ...
                    if table.find(SecondTableArray, "sleepy") then
                        ...
                        repeat 
                            task.wait(1)
                            t = t + 1
                        until not hasTargetAilment("sleepy", petToEquipSecond) or t == 60  -- Check only first table
                ...
                if getgenv().ToiletID then
                    if table.find(FirstTableArray, "toilet") then
                        ...
                        repeat 
                            task.wait(1)
                            t = t + 1
                        until not hasTargetAilment("toilet", petToEquip) or t == 60  -- Check only first table
                    ...
                    if table.find(SecondTableArray, "toilet") then
                        ...
                        repeat 
                            task.wait(1)
                            t = t + 1
                        until not hasTargetAilment("toilet", petToEquipSecond) or t == 60  -- Check only first table
